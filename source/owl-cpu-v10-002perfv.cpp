...
class OwlInstructionHandler
{
public:
    virtual void Ecall() = 0;
    virtual void Ebreak() = 0;
    virtual void Add(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Sub(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Sll(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Slt(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Sltu(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Xor(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Srl(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Sra(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Or(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void And(uint32_t r0, uint32_t r1, uint32_t r2) = 0;
    virtual void Slli(uint32_t r0, uint32_t r1, uint32_t shift) = 0;
    virtual void Srli(uint32_t r0, uint32_t r1, uint32_t shift) = 0;
    virtual void Srai(uint32_t r0, uint32_t r1, uint32_t shift) = 0;
    virtual void Beq(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Bne(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Blt(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Bge(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Bltu(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Bgeu(uint32_t r0, uint32_t r1, int32_t offs12) = 0;
    virtual void Addi(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Slti(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Sltiu(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Xori(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Ori(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Andi(uint32_t r0, uint32_t r1, int32_t imm12) = 0;
    virtual void Lb(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Lbu(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Lh(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Lhu(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Lw(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Sb(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Sh(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Sw(uint32_t r0, int32_t imm12, uint32_t r1) = 0;
    virtual void Fence() = 0;
    virtual void Jalr(uint32_t r0, int32_t offs12, uint32_t r1) = 0;
    virtual void Jal(uint32_t r0, int32_t offs20) = 0;
    virtual void Lui(uint32_t r0, uint32_t uimm20) = 0;
    virtual void Auipc(uint32_t r0, uint32_t uimm20) = 0;
    virtual void J(int32_t offs20) = 0;
    virtual void Call(int32_t offs20) = 0;
    virtual void Ret() = 0;
    virtual void Li(uint32_t r0, int32_t imm12) = 0;
    virtual void Mv(uint32_t r0, uint32_t r1) = 0;
    virtual void Illegal([[maybe_unused]] uint32_t ins) = 0;
};

class OwlCpu : public OwlInstructionHandler
{
...
public:
    ...
    // sll r0, r1, r2
    void Sll(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
        // r0 <- r1 << (r2 % 32)
        x[r0] = x[r1] << (x[r2] % 32);
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // slt r0, r1, r2
    void Slt(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
    ...
    // sltu r0, r1, r2
    void Sltu(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
    ...
    // xor r0, r1, r2
    void Xor(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
        // r0 <- r1 ^ r2
        x[r0] = x[r1] ^ x[r2];
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // srl r0, r1, r2
    void Srl(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
    ...
    // sra r0, r1, r2
    void Sra(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
    ...
    // or r0, r1, r2
    void Or(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
        // r0 <- r1 | r2
        x[r0] = x[r1] | x[r2];
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // and r0, r1, r2
    void And(uint32_t r0, uint32_t r1, uint32_t r2) override
    {
        // r0 <- r1 & r2
        x[r0] = x[r1] & x[r2];
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // slli r0, r1, shift
    void Slli(uint32_t r0, uint32_t r1, uint32_t shift) override
    {
        // r0 <- r1 << shift
        x[r0] = x[r1] << shift;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // srli r0, r1, shift
    void Srli(uint32_t r0, uint32_t r1, uint32_t shift) override
    {
    ...
    // srai r0, r1, shift
    void Srai(uint32_t r0, uint32_t r1, uint32_t shift) override
    {
        // r0 <- r1 >> shift (shift right logical)
        x[r0] = x[r1] >> shift;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // beq r0, r1, offs12
    void Beq(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
    ...
    // bne r0, r1, offs12
    void Bne(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
        // pc <- pc + ((r0 != r1) ? offs12 : 4)
        if (x[r0] != x[r1])
        {
    ...
    // blt r0, r1, offs12
    void Blt(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
    ...
    // bge r0, r1, offs12
    void Bge(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
        // pc <- pc + ((r0 >= r1) ? offs12 : 4) (signed integer comparison)
        int32_t sr0 = static_cast<int32_t>(x[r0]);
        int32_t sr1 = static_cast<int32_t>(x[r1]);
    ...
    // bltu r0, r1, offs12
    void Bltu(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
    ...
    // bgeu r0, r1, offs12
    void Bgeu(uint32_t r0, uint32_t r1, int32_t offs12) override
    {
        // pc <- pc + ((r0 >= r1) ? offs12 : 4) (unsigned integer comparison)
        if (x[r0] >= x[r1])
        {
    ...
    // addi r0, r1, imm12
    void Addi(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
        // r0 <- r1 + imm12
        x[r0] = x[r1] + imm12;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // slti r0, r1, imm12
    void Slti(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
    ...
    // sltiu r0, r1, imm12
    void Sltiu(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
    ...
    // xori r0, r1, imm12
    void Xori(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
        // r0 <- r1 ^ imm12
        x[r0] = x[r1] ^ imm12;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // ori r0, r1, imm12
    void Ori(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
        // r0 <- r1 | imm12
        x[r0] = x[r1] | imm12;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // andi r0, r1, imm12
    void Andi(uint32_t r0, uint32_t r1, int32_t imm12) override
    {
        // r0 <- r1 & imm12
        x[r0] = x[r1] & imm12;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // lb r0, imm12(r1)
    void Lb(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // lbu r0, imm12(r1)
    void Lbu(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // lh r0, imm12(r1)
    void Lh(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // lhu r0, imm12(r1)
    void Lhu(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // lw r0, imm12(r1)
    void Lw(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // sb r0, imm12(r1)
    void Sb(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // sh r0, imm12(r1)
    void Sh(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // sw r0, imm12(r1)
    void Sw(uint32_t r0, int32_t imm12, uint32_t r1) override
    {
    ...
    // jalr r0, offs12(r1)
    void Jalr(uint32_t r0, int32_t offs12, uint32_t r1) override
    {
    ...
    // jal r0, offs20
    void Jal(uint32_t r0, int32_t offs20) override
    {
    ...
    // lui r0, uimm20
    void Lui(uint32_t r0, uint32_t uimm20) override
    {
    ...
    // auipc r0, uimm20
    void Auipc(uint32_t r0, uint32_t uimm20) override
    {
    ...
    // j offs20
    void J(int32_t offs20) override
    {
        // pc <- pc + offs20
    ...
    // call offs20
    void Call(int32_t offs20) override
    {
    ...
    // li r0, imm12
    void Li(uint32_t r0, int32_t imm12) override
    {
        // r0 <- imm12
        x[r0] = imm12;
        x[0] = 0; // Ensure x0 is always zero.
    ...
    // mv r0, r1
    void Mv(uint32_t r0, uint32_t r1) override
    {
        // r0 <- r1
        x[r0] = x[r1];
        x[0] = 0; // Ensure x0 is always zero.
    ...
    void Illegal([[maybe_unused]] uint32_t ins) override
    {
...
void DispatchOwl(OwlInstructionHandler& cpu, uint32_t ins)
{
...
void DispatchRv32i(OwlInstructionHandler& a, uint32_t code)
{
    DecodeRv32 rv(code);
