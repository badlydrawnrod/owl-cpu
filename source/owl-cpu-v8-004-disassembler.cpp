...
void DispatchOwl(OwlHandler auto& handler, uint32_t ins)
{
    ...
    switch (opcode)
    {
        ...
        case Opcode::Sll: return handler.Sll(r0(ins), r1(ins), r2(ins));
        case Opcode::Slt: return handler.Slt(r0(ins), r1(ins), r2(ins));
        case Opcode::Sltu: return handler.Sltu(r0(ins), r1(ins), r2(ins));
        case Opcode::Xor: return handler.Xor(r0(ins), r1(ins), r2(ins));
        case Opcode::Srl: return handler.Srl(r0(ins), r1(ins), r2(ins));
        case Opcode::Sra: return handler.Sra(r0(ins), r1(ins), r2(ins));
        case Opcode::Or: return handler.Or(r0(ins), r1(ins), r2(ins));
        case Opcode::And: return handler.And(r0(ins), r1(ins), r2(ins));
        case Opcode::Slli: return handler.Slli(r0(ins), r1(ins), shift(ins));
        case Opcode::Srli: return handler.Srli(r0(ins), r1(ins), shift(ins));
        case Opcode::Srai: return handler.Srai(r0(ins), r1(ins), shift(ins));
        case Opcode::Beq: return handler.Beq(r0(ins), r1(ins), offs12(ins));
        case Opcode::Bne: return handler.Bne(r0(ins), r1(ins), offs12(ins));
        case Opcode::Blt: return handler.Blt(r0(ins), r1(ins), offs12(ins));
        case Opcode::Bge: return handler.Bge(r0(ins), r1(ins), offs12(ins));
        case Opcode::Bltu: return handler.Bltu(r0(ins), r1(ins), offs12(ins));
        case Opcode::Bgeu: return handler.Bgeu(r0(ins), r1(ins), offs12(ins));
        case Opcode::Addi: return handler.Addi(r0(ins), r1(ins), imm12(ins));
        case Opcode::Slti: return handler.Slti(r0(ins), r1(ins), imm12(ins));
        case Opcode::Sltiu: return handler.Sltiu(r0(ins), r1(ins), imm12(ins));
        case Opcode::Xori: return handler.Xori(r0(ins), r1(ins), imm12(ins));
        case Opcode::Ori: return handler.Ori(r0(ins), r1(ins), imm12(ins));
        case Opcode::Andi: return handler.Andi(r0(ins), r1(ins), imm12(ins));
        case Opcode::Lb: return handler.Lb(r0(ins), imm12(ins), r1(ins));
        case Opcode::Lbu: return handler.Lbu(r0(ins), imm12(ins), r1(ins));
        case Opcode::Lh: return handler.Lh(r0(ins), imm12(ins), r1(ins));
        case Opcode::Lhu: return handler.Lhu(r0(ins), imm12(ins), r1(ins));
        case Opcode::Lw: return handler.Lw(r0(ins), imm12(ins), r1(ins));
        case Opcode::Sb: return handler.Sb(r0(ins), imm12(ins), r1(ins));
        case Opcode::Sh: return handler.Sh(r0(ins), imm12(ins), r1(ins));
        case Opcode::Sw: return handler.Sw(r0(ins), imm12(ins), r1(ins));
        case Opcode::Fence: return handler.Fence();
        case Opcode::Jalr: return handler.Jalr(r0(ins), offs12(ins), r1(ins));
        case Opcode::Jal: return handler.Jal(r0(ins), offs20(ins));
        case Opcode::Lui: return handler.Lui(r0(ins), uimm20(ins));
        case Opcode::Auipc: return handler.Auipc(r0(ins), uimm20(ins));
        case Opcode::J: return handler.J(offs20(ins));
        case Opcode::Call: return handler.Call(offs20(ins));
        case Opcode::Ret: return handler.Ret();
        case Opcode::Li: return handler.Li(r0(ins), imm12(ins));
        case Opcode::Mv: return handler.Mv(r0(ins), r1(ins));
    }
    // clang-format on
    return handler.Illegal(ins);
}
...
void DispatchRv32i(OwlHandler auto& handler, uint32_t code)
{
    DecodeRv32 rv(code);
    ...
    switch (code & 0xfe00707f) {
        ...
        case 0x00001033: return handler.Sll(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00002033: return handler.Slt(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00003033: return handler.Sltu(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00004033: return handler.Xor(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00005033: return handler.Srl(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x40005033: return handler.Sra(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00006033: return handler.Or(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00007033: return handler.And(rv.Rd(), rv.Rs1(), rv.Rs2());
        case 0x00001013: return handler.Slli(rv.Rd(), rv.Rs1(), rv.Shamtw());
        case 0x00005013: return handler.Srli(rv.Rd(), rv.Rs1(), rv.Shamtw());
        case 0x40005013: return handler.Srai(rv.Rd(), rv.Rs1(), rv.Shamtw());
    }
    switch (code & 0x0000707f) {
        case 0x00000063: return handler.Beq(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00001063: return handler.Bne(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00004063: return handler.Blt(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00005063: return handler.Bge(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00006063: return handler.Bltu(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00007063: return handler.Bgeu(rv.Rs1(), rv.Rs2(), rv.Bimmediate());
        case 0x00000067: return handler.Jalr(rv.Rd(), rv.Iimmediate(),rv.Rs1()); // changed order
        case 0x00000013: return handler.Addi(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00002013: return handler.Slti(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00003013: return handler.Sltiu(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00004013: return handler.Xori(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00006013: return handler.Ori(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00007013: return handler.Andi(rv.Rd(), rv.Rs1(), rv.Iimmediate());
        case 0x00000003: return handler.Lb(rv.Rd(), rv.Iimmediate(), rv.Rs1()); // changed order
        case 0x00001003: return handler.Lh(rv.Rd(), rv.Iimmediate(), rv.Rs1()); // changed order
        case 0x00002003: return handler.Lw(rv.Rd(), rv.Iimmediate(), rv.Rs1()); // changed order
        case 0x00004003: return handler.Lbu(rv.Rd(), rv.Iimmediate(), rv.Rs1()); // changed order
        case 0x00005003: return handler.Lhu(rv.Rd(), rv.Iimmediate(), rv.Rs1()); // changed order
        case 0x00000023: return handler.Sb(rv.Rs1(), rv.Simmediate(), rv.Rs2()); // changed order
        case 0x00001023: return handler.Sh(rv.Rs1(), rv.Simmediate(), rv.Rs2()); // changed order
        case 0x00002023: return handler.Sw(rv.Rs1(), rv.Simmediate(), rv.Rs2()); // changed order
        case 0x0000000f: return handler.Fence();
    }
    switch (code & 0x0000007f) {
        case 0x0000006f: return handler.Jal(rv.Rd(), rv.Jimmediate());
        case 0x00000037: return handler.Lui(rv.Rd(), rv.Uimmediate());
        case 0x00000017: return handler.Auipc(rv.Rd(), rv.Uimmediate());
    }
    // clang-format on
...
concept OwlDispatcherFn = OwlHandler<Handler> && std::invocable<Fn, Handler&, uint32_t>;
...
public:
    void Run(OwlDispatcherFn<OwlCpu> auto dispatchFn, std::span<uint32_t> image)
    {
...
public:
    ...
    void Add(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("add r{}, r{}, r{}\n", r0, r1, r2);
    }

    // sub r0, r1, r2
    void Sub(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("sub r{}, r{}, r{}\n", r0, r1, r2);
    }

    // sll r0, r1, r2
    void Sll(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("sll r{}, r{}, r{}\n", r0, r1, r2);
    }

    // slt r0, r1, r2
    void Slt(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("slt r{}, r{}, r{}\n", r0, r1, r2);
    }

    // sltu r0, r1, r2
    void Sltu(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("sltu r{}, r{}, r{}\n", r0, r1, r2);
    }

    // xor r0, r1, r2
    void Xor(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("xor r{}, r{}, r{}\n", r0, r1, r2);
    }

    // srl r0, r1, r2
    void Srl(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("srl r{}, r{}, r{}\n", r0, r1, r2);
    }

    // sra r0, r1, r2
    void Sra(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("sra r{}, r{}, r{}\n", r0, r1, r2);
    }

    // or r0, r1, r2
    void Or(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("or r{}, r{}, r{}\n", r0, r1, r2);
    }

    // and r0, r1, r2
    void And(uint32_t r0, uint32_t r1, uint32_t r2)
    {
        std::cout << std::format("and r{}, r{}, r{}\n", r0, r1, r2);
    }
    ...
    void Slli(uint32_t r0, uint32_t r1, uint32_t shift)
    {
        std::cout << std::format("slli r{}, r{}, {}\n", r0, r1, shift);
    }

    // srli r0, r1, shift
    void Srli(uint32_t r0, uint32_t r1, uint32_t shift)
    {
        std::cout << std::format("srli r{}, r{}, {}\n", r0, r1, shift);
    }

    // srai r0, r1, shift
    void Srai(uint32_t r0, uint32_t r1, uint32_t shift)
    {
        std::cout << std::format("srai r{}, r{}, {}\n", r0, r1, shift);
    }
    ...
    void Beq(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("beq r{}, r{}, {}\n", r0, r1, offs12);
    }

    // bne r0, r1, offs12
    void Bne(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("bne r{}, r{}, {}\n", r0, r1, offs12);
    }

    // blt r0, r1, offs12
    void Blt(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("blt r{}, r{}, {}\n", r0, r1, offs12);
    }

    // bge r0, r1, offs12
    void Bge(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("bge r{}, r{}, {}\n", r0, r1, offs12);
    }

    // bltu r0, r1, offs12
    void Bltu(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("bltu r{}, r{}, {}\n", r0, r1, offs12);
    }

    // bgeu r0, r1, offs12
    void Bgeu(uint32_t r0, uint32_t r1, int32_t offs12)
    {
        std::cout << std::format("bgeu r{}, r{}, {}\n", r0, r1, offs12);
    }
    ...
    void Addi(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("addi r{}, r{}, {}\n", r0, r1, imm12);
    }

    // slti r0, r1, imm12
    void Slti(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("slti r{}, r{}, {}\n", r0, r1, imm12);
    }

    // sltiu r0, r1, imm12
    void Sltiu(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("sltiu r{}, r{}, {}\n", r0, r1, imm12);
    }

    // xori r0, r1, imm12
    void Xori(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("xori r{}, r{}, {}\n", r0, r1, imm12);
    }

    // ori r0, r1, imm12
    void Ori(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("ori r{}, r{}, {}\n", r0, r1, imm12);
    }

    // andi r0, r1, imm12
    void Andi(uint32_t r0, uint32_t r1, int32_t imm12)
    {
        std::cout << std::format("andi r{}, r{}, {}\n", r0, r1, imm12);
    }
    ...
    void Lb(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("lb r{}, {}(r{})\n", r0, imm12, r1);
    }

    // lbu r0, imm12(r1)
    void Lbu(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("lw r{}, {}(r{})\n", r0, imm12, r1);
    }

    // lh r0, imm12(r1)
    void Lh(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("lh r{}, {}(r{})\n", r0, imm12, r1);
    }

    // lhu r0, imm12(r1)
    void Lhu(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("lhu r{}, {}(r{})\n", r0, imm12, r1);
    }
    ...
    void Sb(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("sb r{}, {}(r{})\n", r0, imm12, r1);
    }

    // sh r0, imm12(r1)
    void Sh(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("sh r{}, {}(r{})\n", r0, imm12, r1);
    }

    // sw r0, imm12(r1)
    void Sw(uint32_t r0, int32_t imm12, uint32_t r1)
    {
        std::cout << std::format("sw r{}, {}(r{})\n", r0, imm12, r1);
    }
    ...
    void Jalr(uint32_t r0, int32_t offs12, uint32_t r1)
    {
        std::cout << std::format("jalr r{}, {}(r{})\n", r0, offs12, r1);
    }

    // jal r0, offs20
    void Jal(uint32_t r0, int32_t offs20)
    {
        std::cout << std::format("jal r{}, {}\n", r0, offs20);
    }
    ...
    void Lui(uint32_t r0, uint32_t uimm20)
    {
        std::cout << std::format("lui r{}, {}\n", r0, uimm20);
    }

    // auipc r0, uimm20
    void Auipc(uint32_t r0, uint32_t uimm20)
    {
        std::cout << std::format("auipc r{}, {}\n", r0, uimm20);
    }
    ...
    void Li(uint32_t r0, int32_t imm12)
    {
        std::cout << std::format("li r{}, {}\n", r0, imm12);
    }

    // mv r0, r1
    void Mv(uint32_t r0, uint32_t r1)
    {
        std::cout << std::format("mv r{}, r{}\n", r0, r1);
    }
...
void Disassemble(OwlDispatcherFn<Disassembler> auto dispatchFn, std::span<uint32_t> image)
{
    Disassembler d;
    uint32_t address = 0;
    for (auto code : image)
...
{
    Disassemble(DispatchRv32i<Disassembler>, image);
}

void DisassembleOwl(std::span<uint32_t> image)
{
    Disassemble(DispatchOwl<Disassembler>, image);
}
